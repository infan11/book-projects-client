        ...
        <div>
            <div>
             ...
             <div className='grid md:grid-cols-2  mb-5'>
                ...
                <button className='  bg-blue-600 text-white p-2 w-44 font-bold text-xl  rounded lg:ml-[420px]'>Browse all Books</button>
             </div>
            </div>
            <div  className=' max-w-7xl  grid md:grid-cols-4 '>
           {
