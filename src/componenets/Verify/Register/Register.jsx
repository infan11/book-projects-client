...
const Register = () => {
  ...
  <div className="hero-content flex-col lg:flex-row-reverse">
    <div className="text-center hidden lg:block lg:text-left ">
       <img src={image} className=' ml-14 w-[700px]   ' alt="" />
    </div>
    <div className=" fromDiv rounded-lg  md:w-96 md:px-8  lg:w-ful  bg-white ">
      <form className=" lg:w-1/2  lg:mx-auto lg:ml-2  "> 
        ...
        <button className="flex items-center gap-2 ml-2 text-black"><FcGoogle /> Continue With Google</button>
        </div>
        
        <div className='formInput   p-2 bg-white md:w-60 rounded-lg   font-bold  lg:w-80'>
        <button className="flex items-center gap-2 ml-2  text-black"><FaGithub /> Continue With Github</button>
        </div>
